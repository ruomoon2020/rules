...
发版或大改 `shared/` 后，在测试仓库执行 `evals/prompts.md` 中 **E01–E40**，按 `evals/rubric.md` 记分，结果记入 `evals/results-YYYY-MM-DD.md`（由 `results-template.md` 复制）。

通过门槛：**P0 8/8 Pass**，**P1 至少 29/32 Pass**。日常 **Smoke**、成熟后台业务 PR **Business Extension（E32–E40，9/9）**、发版 **Full**（见 `evals/README.md`、`evals/smoke-prompts.md`）。
